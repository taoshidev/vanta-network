...
class MinerStatisticsManager:
    ...
    def __init__(
        ...
        Args:
            ...
            wallet: Optional wallet for ZK proof signing
        """
    ...
    def generate_miner_statistics_data(
        ...
        maincomp_ledger = self._perf_ledger_client.filtered_ledger_for_scoring(hotkeys=[*challengeperiod_success_hotkeys, *challengeperiod_probation_hotkeys])
