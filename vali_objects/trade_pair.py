...
class TradePair(Enum):
    ...
    INDA = ["INDA", "INDA", 0.00009, EQUITIES_MIN_LEVERAGE, EQUITIES_MAX_LEVERAGE, TradePairCategory.EQUITIES, InstrumentType.SPOT, SubaccountTierBaseLeverage(0.5), False]
    ...
    NVDAUSDC  = ["NVDAUSDC",  "NVDA/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:NVDA",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    AAPLUSDC  = ["AAPLUSDC",  "AAPL/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:AAPL",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    TSLAUSDC  = ["TSLAUSDC",  "TSLA/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:TSLA",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.CONSUMER_DISCRETIONARY, False]
    MSFTUSDC  = ["MSFTUSDC",  "MSFT/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:MSFT",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    AMZNUSDC  = ["AMZNUSDC",  "AMZN/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:AMZN",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.CONSUMER_DISCRETIONARY, False]
    GOOGLUSDC = ["GOOGLUSDC", "GOOGL/USDC", 0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:GOOGL", InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.COMMUNICATION, False]
    METAUSDC  = ["METAUSDC",  "META/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:META",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.COMMUNICATION, False]
    COINUSDC  = ["COINUSDC",  "COIN/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:COIN",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.FINANCIALS, False]
    CRCLUSDC  = ["CRCLUSDC",  "CRCL/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:CRCL",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    MSTRUSDC  = ["MSTRUSDC",  "MSTR/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:MSTR",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    PLTRUSDC  = ["PLTRUSDC",  "PLTR/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:PLTR",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    AMDUSDC   = ["AMDUSDC",   "AMD/USDC",   0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:AMD",   InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    TSMUSDC   = ["TSMUSDC",   "TSM/USDC",   0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:TSM",   InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    NFLXUSDC  = ["NFLXUSDC",  "NFLX/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:NFLX",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.COMMUNICATION, False]
    SNDKUSDC  = ["SNDKUSDC",  "SNDK/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:SNDK",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    INTCUSDC  = ["INTCUSDC",  "INTC/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:INTC",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    MUUSDC    = ["MUUSDC",    "MU/USDC",    0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:MU",    InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    HOODUSDC  = ["HOODUSDC",  "HOOD/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:HOOD",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.FINANCIALS, False]
    ORCLUSDC  = ["ORCLUSDC",  "ORCL/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:ORCL",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.INFORMATION_TECHNOLOGY, False]
    SPCXUSDC  = ["SPCXUSDC",  "SPCX/USDC",  0.001, HS_MIN_LEVERAGE, HS_MAX_LEVERAGE, TradePairCategory.EQUITIES, None, TradePairSource.HYPERLIQUID, "xyz:SPCX",  InstrumentType.PERP, SubaccountTierBaseLeverage(0.5), ExposureGroup.COMMUNICATION, False]
