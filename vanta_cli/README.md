...
**Vanta CLI** is a command-line tool that is an extension of bittensor-cli for Vanta Network operations. It provides collateral management functionality and extends all standard bittensor-cli operations. Help information can be invoked for every command and option with `--help` option.
