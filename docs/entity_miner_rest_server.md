...
- `account_type` (string, optional): `"standard"` (default) or `"pro"` — see [entity_miner.md](entity_miner.md#account-types). Fixed for the life of the subaccount once created.
