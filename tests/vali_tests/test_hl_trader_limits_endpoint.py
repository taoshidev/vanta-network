...
TIER2_PORTFOLIO  = ValiConfig.SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS[2][MinerAssetClass.HL_ALL]   # 10.0x
...
TIER1_PORTFOLIO  = ValiConfig.SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS[1][MinerAssetClass.HL_ALL]   # 10.0x
...
class TestHlTraderLimitsEndpoint(unittest.TestCase):
    ...
    def test_hl_all_overall_cap_from_asset_class_table(self):
        """HL_ALL max_portfolio_usd sources from the HL_ALL entry in SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS."""
        ...
        self.assertEqual(status, 200)
        expected_overall = ACCOUNT_SIZE * ValiConfig.SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS[2][MinerAssetClass.HL_ALL]
    ...
    def test_hl_all_challenge_period_uses_tier_1(self):
        """HL_ALL during challenge period uses tier-1 entry in SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS."""
        from vali_objects.vali_config import ValiConfig
        from vali_objects.enums.miner_asset_class_enum import MinerAssetClass
        self.mock_entity.get_hl_subaccount_limits_data.return_value = _build_limits_data(
            asset_class="hl_all",
        ...
        self.assertEqual(
            ...
            ACCOUNT_SIZE * ValiConfig.SUBACCOUNT_TIER_PORTFOLIO_LEVERAGE_BY_ASSET_CLASS[1][MinerAssetClass.HL_ALL],
        )
