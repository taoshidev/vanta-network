...
# ---------------------------------------------------------------------------
# MinerStatisticsManagerServer
# ---------------------------------------------------------------------------
class MinerStatisticsManagerServer:
    """
    Server class for miner statistics generation and management.
    ...
    # -------------------------------------------
    # RPC Methods (exposed via RPC)
    # -------------------------------------------
    def get_compressed_statistics_rpc(self, include_checkpoints: bool = True) -> bytes | None:
        """
        Get pre-compressed statistics payload for immediate RPC response.
        ...
        Similar to DebtLedgerManagerServer.get_compressed_summaries_rpc().
...
if __name__ == "__main__":
    ...
    msm = MinerStatisticsManagerServer(position_manager, subtensor_weight_setter, plagiarism_detector, contract_manager=contract_manager)
    pwd = os.getcwd()
